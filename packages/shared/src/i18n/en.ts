...
timetable: {
    ...
    pendingEditsTitle: 'Time changes waiting for you',
    approveEdit: 'Approve the change',
    refuseEdit: 'Keep the current time',
    changeTime: 'Change time',
    changeTimePrompt: 'New time for this period, as HH:MM-HH:MM. It is currently {current}.',
    badTime: 'Enter the time as HH:MM-HH:MM, with the end after the start.',
    pendingEdit: 'Change to {time} waiting for admin approval. Your class still sees the time above.',
    withdraw: 'Withdraw',
    confirm: 'Confirm',
    reject: 'Refuse',
