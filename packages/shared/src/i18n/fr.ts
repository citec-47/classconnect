...
export const fr: Messages = {
  ...
  admin: {
    ...
    /* Voir en.ts : « Privé » est un type d’inscription et non un niveau. */
    schoolSixthForm: 'Première et Terminale',
    schoolPrivate: 'Cours privés',
    allSchools: 'Toutes',
    selectAll: 'Tout sélectionner ({count})',
    selectedCount: '{count} sélectionné(s)',
    deleteSelected: 'Supprimer la sélection',
    confirmDelete: 'Supprimer {count} — action irréversible',
  ...
  schedule: {
    ...
    room: {
      ...
      /* Voir en.ts : nomme l’état, pas le refus. */
      listenOnly: 'Écoute seule',
      cameraOff: 'Couper la caméra',
      cameraOn: 'Activer la caméra',
      expandTile: 'Afficher {name} en grand',
      shrinkTile: 'Revenir à l’enseignant',
      pinned: 'Épinglé',
      muteAllMics: 'Couper tous les micros',
      muteAllCameras: 'Couper toutes les caméras',
...
timetable: {
    ...
    pendingEditsTitle: 'Changements d’heure en attente',
    approveEdit: 'Approuver le changement',
    refuseEdit: 'Conserver l’heure actuelle',
    changeTime: 'Modifier l’heure',
    changeTimePrompt: 'Nouvelle heure pour ce cours, au format HH:MM-HH:MM. Actuellement {current}.',
    badTime: 'Saisissez l’heure au format HH:MM-HH:MM, la fin après le début.',
    pendingEdit: 'Changement vers {time} en attente d’approbation. Votre classe voit toujours l’heure ci-dessus.',
    withdraw: 'Retirer',
    confirm: 'Confirmer',
    reject: 'Refuser',
    free: 'Rien de prévu',
